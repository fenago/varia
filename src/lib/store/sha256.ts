/**
 * Minimal synchronous SHA-256 (FIPS 180-4) over a UTF-8 string, returning hex.
 * Used for evidence record hashes so the seed can compute them without
 * `crypto.subtle` (which is async and absent in some test environments).
 */
