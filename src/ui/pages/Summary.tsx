...
import { APPROACH, BOTTOM_LINE, COLLEGE_GETS, EVIDENCE, EXEC, GLANCE, LIMITS, NEXT_STEPS, PATH_STEPS, SHIFTS, SITUATION } from "@shared/summary";
...
export default function Summary() {
  usePageTitle("Executive summary", "Orientation");
