  ...
  return (
    <div className="va-page va-page-narrow" style={{ gap: 26 }}>
      <Blueprint className="va-dark" style={{ padding: "26px 28px" }}>
        ...
        <p style={{ margin: 0, maxWidth: "68ch", fontSize: 15, lineHeight: 1.6, textWrap: "pretty" }}>{a.lede}</p>
      </Blueprint>
      ...
      <Blueprint style={{ padding: "20px 22px" }}>
        ...
        <div className="va-surface-box" style={{ fontSize: 14, lineHeight: 1.6 }}>{a.costs}</div>
      ...
      <div className="text-muted" style={{ fontSize: 12.5, display: "flex", gap: 14, flexWrap: "wrap", alignItems: "baseline" }}>
